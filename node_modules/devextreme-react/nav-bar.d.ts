...
declare type INavBarOptions<TItem = any, TKey = any> = React.PropsWithChildren<Properties<TItem, TKey> & IHtmlOptions & {
...
declare class NavBar<TItem = any, TKey = any> extends BaseComponent<React.PropsWithChildren<INavBarOptions<TItem, TKey>>> {
    get instance(): dxNavBar<TItem, TKey>;

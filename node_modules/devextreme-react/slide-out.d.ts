...
declare type ISlideOutOptions<TItem = any, TKey = any> = React.PropsWithChildren<Properties<TItem, TKey> & IHtmlOptions & {
...
declare class SlideOut<TItem = any, TKey = any> extends BaseComponent<React.PropsWithChildren<ISlideOutOptions<TItem, TKey>>> {
    get instance(): dxSlideOut<TItem, TKey>;

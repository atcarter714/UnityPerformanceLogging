...
var SchedulerWorkSpace = function(_WidgetObserver) {
    ...
    _proto._createDragBehaviorBase = function($element, options) {
        ...
        this.dragBehavior.addTo($element, createDragBehaviorConfig(container, this.isDefaultDraggingMode, this.dragBehavior, (function() {
...
var createDragBehaviorConfig = function(container, isDefaultDraggingMode, dragBehavior, enableDefaultDragging, disableDefaultDragging, getDroppableCell, getDateTables, removeDroppableCellClass, getCellWidth, options) {
    var state = {
        dragElement: void 0,
        itemData: void 0
    };

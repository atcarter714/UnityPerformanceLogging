    ...
    _proto._onParentTasksRecalculated = function(data) {
        ...
        if (!this.isSieving) {
            ...
            setTimeout((function() {
                ...
                return null === (_this7$_ganttTreeList = _this7._ganttTreeList) || void 0 === _this7$_ganttTreeList ? void 0 : _this7$_ganttTreeList.setDataSource(treeDataSource)
            }))
        }
    ...
    _proto._optionChanged = function(args) {
        ...
        switch (args.name) {
            ...
            case "resourceAssignments":
                ...
                break;
            case "columns":
                null === (_this$_ganttTreeList3 = this._ganttTreeList) || void 0 === _this$_ganttTreeList3 ? void 0 : _this$_ganttTreeList3.setOption("columns", this._ganttTreeList.getColumns());
                break;
            case "taskListWidth":
            ...
            case "endDateRange":
                ...
                break;
            case "selectedRowKey":
                null === (_this$_ganttTreeList4 = this._ganttTreeList) || void 0 === _this$_ganttTreeList4 ? void 0 : _this$_ganttTreeList4.selectRows(_uiGantt6.GanttHelper.getArrayFromOneElement(args.value));
                break;
            ...
            case "onScaleCellPrepared":
                ...
                break;
            case "allowSelection":
                null === (_this$_ganttTreeList5 = this._ganttTreeList) || void 0 === _this$_ganttTreeList5 ? void 0 : _this$_ganttTreeList5.setOption("selection.mode", _uiGantt6.GanttHelper.getSelectionMode(args.value));
                this._setGanttViewOption("allowSelection", args.value);
                break;
            case "showRowLines":
                null === (_this$_ganttTreeList6 = this._ganttTreeList) || void 0 === _this$_ganttTreeList6 ? void 0 : _this$_ganttTreeList6.setOption("showRowLines", args.value);
            ...
            case "taskContentTemplate":
                ...
                break;
            case "rootValue":
                null === (_this$_ganttTreeList7 = this._ganttTreeList) || void 0 === _this$_ganttTreeList7 ? void 0 : _this$_ganttTreeList7.setOption("rootValue", args.value);
                break;
            case "width":
            ...
            case "height":
                ...
                break;
            case "sorting":
                null === (_this$_ganttTreeList8 = this._ganttTreeList) || void 0 === _this$_ganttTreeList8 ? void 0 : _this$_ganttTreeList8.setOption("sorting", this.option(args.name));
                break;
            case "filterRow":
                null === (_this$_ganttTreeList9 = this._ganttTreeList) || void 0 === _this$_ganttTreeList9 ? void 0 : _this$_ganttTreeList9.setOption("filterRow", this.option(args.name));
                break;
            case "headerFilter":
                null === (_this$_ganttTreeList10 = this._ganttTreeList) || void 0 === _this$_ganttTreeList10 ? void 0 : _this$_ganttTreeList10.setOption("headerFilter", this.option(args.name));
                break;
            default:
                _Widget.prototype._optionChanged.call(this, args)
        }
